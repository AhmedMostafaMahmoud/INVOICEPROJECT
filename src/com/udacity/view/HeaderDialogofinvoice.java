 ...
 * @author DELL
 */
public class HeaderDialogofinvoice extends JDialog {
    ...
    public HeaderDialogofinvoice(InvoiceFrame frame) {
    ...
    public JTextField InvoiceDateFieldgetting() {
        return invDateField;
    }

    public JTextField CustomerNameFieldgetting() {
